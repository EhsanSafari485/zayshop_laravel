                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                                    <div class="d-flex justify-content-sm-end justify-content-center">
                                        <a href="<?php echo e(route('Panel.product.create')); ?>" id="btn-add-contact" style="display: inline-block;">
                                        ...
                                        <!-- دکمه افزودن رنگ -->
                                        <a href="<?php echo e(route('Panel.product.colors.index')); ?>" id="btn-add-contact" style="display: inline-block;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                 viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <!-- دکمه افزودن سایز -->
                                        <a href="<?php echo e(route('Panel.product.sizes.index')); ?>" id="btn-add-contact" class="btn-add-item" style="display: inline-block;">
                            ...
                            <div class="searchable-items list">
                                ...
                                <div class="items" id="category-<?php echo e($product->id); ?>">
                                    <div class="item-content">
                                        <div class="user-email">
                                            <p class="info-title">نام محصول: </p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($product->name); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">قیمت</p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e(number_format($product->price, 0)); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">تخفیف</p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e(number_format($product->discount)); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">برند</p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($product->brand); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">slug</p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($product->slug); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">دسته بندی</p>
                                            <?php $__currentLoopData = $Categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($Category->id==$product->category_id): ?>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($Category->name); ?></p>
                                            <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="action-btn">
                                            <a href="<?php echo e(route('Panel.product.edit',$product->id)); ?>">
                                            ...
                                            <a href="<?php echo e(route('Panel.product.product_image.index', $product->id)); ?>">
                                            ...
                                            <a href="<?php echo e(route('Panel.product.attribute.index',$product->id)); ?>">
                                                <button type="button" class="custom-gallery-btn" style="background: none; border: none; cursor: pointer;">
                                            ...
                                            <a href="<?php echo e(route('Panel.product.product_variants.index',$product->id)); ?>"><button type="button" class="custom-gallery-btn" style="background: none; border: none; cursor: pointer;">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
...
<?php echo $__env->make('Panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Panel/product/index.blade.php ENDPATH**/ ?>