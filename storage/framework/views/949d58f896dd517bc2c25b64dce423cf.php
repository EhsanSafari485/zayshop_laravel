	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="<?php echo e(route('register')); ?>" class="login100-form" id="registerForm" method="POST">
                    <?php echo csrf_field(); ?>
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						<div>
							<a href="<?php echo e(route('loginForm')); ?>" class="txt5">
								حساب کاربری دارم
							</a>
						</div>
					</div>
...
<?php echo JsValidator::formRequest('App\Http\Requests\auth\registerRequest', '#registerForm'); ?>



</body>
</html>
<?php /**PATH C:\xampp\htdocs\zayShop\resources\views/auth/register.blade.php ENDPATH**/ ?>