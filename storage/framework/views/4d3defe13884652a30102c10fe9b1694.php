                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                            ...
                            <div class="searchable-items list">
                                ...
                                <div class="items" id="image-<?php echo e($order->id); ?>">
                                    <div class="item-content">
                                        <div class="user-email">
                                            <p class="usr-email-addr"></p>
                                            <p class="usr-email-addr"><?php echo e($order->id); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($order->user->name); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e(\Morilog\Jalali\Jalalian::fromDateTime($order->paid_at)->format('%Y/%m/%d')); ?></p>
                                        </div>
                                        <div class="user-email">
                                        <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($order->transaction_id); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <?php
                                            $totalPrice=0;
                                            ...
                                            ?>
                                        <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($totalPrice); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <?php
                                            $statuses = [
                                            ...
                                            <p class="<?php echo e($statusData['class']); ?>">
                                        ...
                                        <div class="user-email">
                                            ...
                                            ?>
                                            <select name="shipping_status" class="form-control status-select" data-order-id="<?php echo e($order->id); ?>">
                                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>" <?php echo e($order->shipping_status == $key ? 'selected' : ''); ?>>
                                                        <?php echo e($status['label']); ?>

                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <div class="status-message mt-2" id="status-message-<?php echo e($order->id); ?>"></div>
                                        </div>
                                        <div class="action-btn">
                                        <button data-id="<?php echo e($order->id); ?>" class="btn btn-info btn-show-details view-order" title="نمایش جزئیات">
...
<script>
    ...
    $('.status-select').on('change', function () {
        ...
        $.ajax({
            url: '<?php echo e(route("Panel.orders.updateStatus", ":id")); ?>'.replace(':id', orderId),
            method: 'POST',
            data: {
...
$(document).on('click', '.view-order', function () {
    var id = $(this).data('id');
    $.ajax({
        url: '<?php echo e(route("Panel.orders.productOrder")); ?>',
        type: 'GET',
        data: { id: id },
...
<?php echo $__env->make('Panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Panel/orders/index.blade.php ENDPATH**/ ?>