...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('HomeAsset/img/apple-icon.png')); ?> ">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('HomeAsset/img/apple-icon.png')); ?> ">

    <link rel="stylesheet" href="<?php echo e(asset('HomeAsset/css/bootstrap.min.css')); ?> ">
    <link rel="stylesheet" href="<?php echo e(asset('HomeAsset/css/templatemo.css')); ?> ">
    <link rel="stylesheet" href="<?php echo e(asset('HomeAsset/css/custom.css')); ?> ">

    <!-- Load fonts style after rendering the layout styles -->
    <link rel="stylesheet" href="<?php echo e(asset('HomeAsset/css/fontawesome.min.css')); ?> ">
    <link rel="stylesheet" href="<?php echo e(asset('HomeAsset/css/fonts.css')); ?> ">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow fixed-top">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="<?php echo e(route('Home.index')); ?>">
                زی
            </a>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('Home.index')); ?>">خانه</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('Home.shop')); ?>">فروشگاه</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('Home.about')); ?>">درباره</a>
                        </li>
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <li class="nav-item dropdown">
                        <?php if(auth()->guard()->check()): ?>
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown"
                               aria-expanded="false">
                                <i class="fa fa-fw fa-user text-dark mr-1"></i> <?php echo e(Auth::user()->name); ?>

                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                <?php if(in_array(Auth::user()->role,['admin','master'])): ?>
                                <li><a class="dropdown-item" href="<?php echo e(route('Panel.index')); ?>">پنل کاربری</a></li>
                                <?php else: ?>
                                <li><a class="dropdown-item" href="<?php echo e(route('Panel.account.index')); ?>">پنل کاربری</a></li>
                                <?php endif; ?>
                                <li>
                        ...
                        <?php else: ?>
                        <div class="d-flex">
                            <a class="nav-link" href="<?php echo e(route('loginForm')); ?>">
                                <i class="fa fa-fw fa-user text-dark mr-1"></i> ورود
                            </a>
                            <a class="nav-link" href="<?php echo e(route('registerForm')); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                    <a class="nav-icon position-relative text-decoration-none" href="<?php echo e(route('Home.cart.cart')); ?>">
                        <i class="fa fa-fw fa-cart-arrow-down text-dark mr-1"></i>
                        
                    </a>
                    <a class="nav-icon position-relative text-decoration-none" href="<?php echo e(route('Home.favorite.index')); ?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content border-0">
            <div class="modal-body pt-3">
                <form action="<?php echo e(route('Home.shop')); ?>" method="GET">
...
<?php echo $__env->yieldContent('content'); ?>
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="<?php echo e(asset("HomeAsset/img/brand_01.png")); ?> " alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="<?php echo e(asset("HomeAsset/img/brand_02.png")); ?> " alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="<?php echo e(asset("HomeAsset/img/brand_03.png")); ?> " alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="<?php echo e(asset("HomeAsset/img/brand_04.png")); ?> " alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End First slide-->
    ...
    <script src="<?php echo e(asset('HomeAsset/js/jquery-1.11.0.min.js')); ?>"></script>
    <script src="<?php echo e(asset('HomeAsset/js/jquery-migrate-1.2.1.min.js')); ?>"></script>
...
$(document).ready(function () {
    ...
    $('#inputModalSearch').on('input', function () {
        ...
        if (query.length > 1) {
            $.ajax({
                url: '<?php echo e(route("Home.suggestions")); ?>',
                data: { q: query },
    ...
    <script src="<?php echo e(asset('HomeAsset/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('HomeAsset/js/templatemo.js')); ?>"></script>
    <script src="<?php echo e(asset('HomeAsset/js/custom.js')); ?>"></script>
    <script src="<?php echo e(asset('HomeAsset/assets/js/slick.min.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Home/master.blade.php ENDPATH**/ ?>