                        ...
                        <div class="widget-content searchable-container list">
                            ...
                            <div class="row">
                                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                                   ...
                                   <div id="btn-add-contact" class="btn-add-item float-left" style="display: inline-block;">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="add-contact-box">
                                                        <div class="add-contact-content">
                                                            <form id="addContactModalTitle" method="POST" action="<?php echo e(route('Panel.product.sizes.store')); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="contact-location">
                                                                            <label for="name">نام سایز</label>
                            ...
                            <div class="searchable-items grid">
                                ...
                                <div class="items" id="image-<?php echo e($size->id); ?>">
                                    <div class="item-content">
                                        <div class="user-email">
                                            <p class="info-title"> سایز: </p>
                                            <p class="usr-email-addr" style="font-size: 40px" data-email="alan@mail.com"><?php echo e($size->name); ?></p>
                                        </div>
...
<div class="items" id="image-${item.id}">
    <div class="item-content">
        <div class="user-email">
            <p class="info-title"> سایز: </p>
            <p class="usr-email-addr" style="font-size: 40px" data-email="alan@mail.com">${item.name}</p>
        </div>
        <div class="action-btn">
...
$('.searchable-items.grid').append(newItem);
    ...
    $('.custom-delete-btn').click(function () {
        let id = $(this).data('id');
        let deleteUrl = "/Panel/product/sizes/index/" + id;
...
<?php echo $__env->make('Panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Panel/product/size/index.blade.php ENDPATH**/ ?>