                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                                    <div class="d-flex justify-content-sm-end justify-content-center">
                                        <a href="<?php echo e(route('Panel.category.create')); ?>" id="btn-add-contact" style="display: inline-block;">
                            ...
                            <div class="searchable-items list">
                                ...
                                <div class="items" id="category-<?php echo e($Category->id); ?>">
                                    <div class="item-content">
                                        <div class="user-email">
                                            <p class="info-title">نام دسته بندی: </p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($Category->name); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">slug</p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($Category->slug); ?></p>
                                        </div>
                                        <div class="user-phone">
                                            <img src="<?php echo e(asset('images/Category/'.$Category->image)); ?>" style="border-radius: 5px" width="50px" height="35px" alt="avatar">
                                        </div>
                                        <div class="action-btn">
                                            <a href="<?php echo e(route('Panel.category.edit',$Category->id)); ?>">
...
$(document).ready(function () {
    ...
    $('.custom-delete-btn').click(function () {
        let id = $(this).data('id');
        let deleteUrl = "/Panel/category/index/" + id;
...
<?php echo $__env->make('Panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Panel/Category/index.blade.php ENDPATH**/ ?>