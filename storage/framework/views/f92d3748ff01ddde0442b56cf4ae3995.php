                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="add-contact-box">
                                                        <div class="add-contact-content">
                                                            <form id="addContactModalTitle" method="POST" action="<?php echo e(route('Panel.product.colors.store')); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-6">
                            ...
                            <div class="searchable-items grid">
                                ...
                                <div class="items" id="image-<?php echo e($color->id); ?>">
                                    <div class="item-content">
                                        <div class="user-email">
                                            <p class="info-title">نام رنگ: </p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($color->name); ?></p>
                                        </div>
                                        <div class="user-email">
                                            <div class="usr-email-addr" style="border-radius: 7px;height: 50px;width: 120px; background-color: <?php echo e($color->code); ?>"></div>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">کد رنگ</p>
                                            <p class="usr-email-addr" data-email="alan@mail.com"><?php echo e($color->code); ?></p>
                                        </div>
...
<?php echo $__env->make('Panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Panel/product/color/index.blade.php ENDPATH**/ ?>