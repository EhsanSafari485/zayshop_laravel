                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="add-contact-box">
                                                        <div class="add-contact-content">
                                                            <form id="addContactModalTitle" method="POST" action="<?php echo e(route('Panel.product.product_image.store',$id)); ?>" enctype="multipart/form-data">
                                                                <?php echo csrf_field(); ?>
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="contact-location">
                                                                            <i class="flaticon-location-1"></i>
                                                                            <input type="file" id="c-location" class="form-control" name="images[]" multiple>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="searchable-items grid">
                                ...
                                <div class="items" id="image-<?php echo e($product_image->id); ?>">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            <img src="<?php echo e(asset('images/product/'.$product_image->image)); ?>" width="200px" height="150px" alt="image">
                                        </div>
                                        <div class="action-btn">
                                            <button type="button"
                                            data-id="<?php echo e($product_image->id); ?>"
...
<div class="items" id="image-${item.id}">
    <div class="item-content">
        <div class="user-profile">
            <img src="/images/product/${item.image}" width="200px" height="150px" alt="image">
        </div>
        <div class="action-btn">
...
$('.searchable-items.grid').append(newItem);
    ...
    $('.searchable-items.grid').on('click', '.custom-delete-btn', function () {
        let id = $(this).data('id');
        let deleteUrl = "/Panel/product/product_image/index/" + id;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            Swal.fire('خطا!', 'خطایی در حذف  تصویر پیش آمد.', 'error');
                        }
                    },
                    error: function () {
...
<?php echo $__env->make('Panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zayShop\resources\views/Panel/product/product_image/index.blade.php ENDPATH**/ ?>