	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form" action="{{ route('login') }}" id="registerForm" method="POST">
                    @csrf
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<div>
							<a href="{{ route('registerForm') }}" class="txt5">
								حساب کاربری ندارم
							</a>
						</div>
					</div>
...
{!! JsValidator::formRequest('App\Http\Requests\auth\loginRequest', '#registerForm'); !!}
