                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-7 col-sm-5 text-sm-right text-center layout-spacing align-self-center">
                                    <div class="d-flex justify-content-sm-end justify-content-center">
                                        <a href="{{ route('Panel.category.create') }}" id="btn-add-contact" style="display: inline-block;">
                            ...
                            <div class="searchable-items list">
                                ...
                                <div class="items" id="category-{{ $Category->id }}">
                                    <div class="item-content">
                                        <div class="user-email">
                                        ...
                                        <div class="user-email">
                                            ...
                                            <p class="usr-email-addr" data-email="alan@mail.com">{{$Category->slug}}</p>
                                        </div>
                                        <div class="user-phone">
                                            <img src="{{ asset('images/Category/'.$Category->image) }}" style="border-radius: 5px" width="50px" height="35px" alt="avatar">
                                        </div>
