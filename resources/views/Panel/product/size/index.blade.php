                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="add-contact-box">
                                                        <div class="add-contact-content">
                                                            <form id="addContactModalTitle" method="POST" action="{{ route('Panel.product.sizes.store') }}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md-12">
                            ...
                            <div class="searchable-items grid">
                                ...
                                <div class="items" id="image-{{$size->id}}">
                                    <div class="item-content">
                                        <div class="user-email">
                                            <p class="info-title"> سایز: </p>
                                            <p class="usr-email-addr" style="font-size: 40px" data-email="alan@mail.com">{{$size->name}}</p>
                                        </div>
