                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="add-contact-box">
                                                        <div class="add-contact-content">
                                                            <form id="addContactModalTitle" method="POST" action="{{ route('Panel.product.attribute.store',$id) }}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md-12">
                            ...
                            <div class="searchable-items list">
                                ...
                                <div class="items" id="image-{{$attribute->id}}">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            <p class="usr-email-addr" data-email="alan@mail.com">{{$attribute->attribute}}</p>
                                        </div>
