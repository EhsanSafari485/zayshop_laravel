                    ...
                    <div class="col-lg-12">
                        <div class="widget-content searchable-container list">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="add-contact-box">
                                                        <div class="add-contact-content">
                                                            <form id="addContactModalTitle" method="POST" action="{{ route('Panel.product.product_variants.store',$id) }}" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    {{-- <button type="button" class="btn" id="btn-add">افزودن</button> --}}
                            ...
                            <div class="searchable-items list">
                                ...
                                <div class="items" id="image-{{$product_variant->id}}">
                                    <div class="item-content">
                                        @foreach ($colors as $color)
                                        @if ($color->id==$product_variant->color_id)
                                        <div class="user-email">
                                            <p class="usr-email-addr" style="border-radius: 7px;height: 30px;width: 30px; background-color: {{$color->code}}" data-email="alan@mail.com"></p>
                                            <p class="usr-email-addr">{{$color->name}}</p>
                                        </div>
                                        @endif
                                        @endforeach
                                        @foreach ($sizes as $size)
                                        @if ($size->id==$product_variant->size_id)
                                        <div class="user-email">
                                            <p class="usr-email-addr" data-email="alan@mail.com">{{$size->name}}</p>
                                        </div>
                                        @endif
                                        @endforeach
                                        {{-- <div class="user-email">
                                            <p class="usr-email-addr" data-email="alan@mail.com">{{$product_variant->size_id}}</p>
                                        </div> --}}
                                        <div class="user-email">
                                        @if ($product_variant->stock==0)
                                        <p class="usr-email-addr" data-email="alan@mail.com" style="color: red">اتمام موجودی</p>
                                        @else
                                        <p class="usr-email-addr" data-email="alan@mail.com">{{$product_variant->stock}}</p>
                                        @endif
                                        </div>
