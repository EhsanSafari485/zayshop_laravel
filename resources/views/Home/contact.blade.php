...
<head>
    <title>فروشگاه زی - تماس با ما</title>
    <meta charset="utf-8">
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">021-020-0340</a>
                </div>
                <div>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                ...
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-icon position-relative text-decoration-none" href="#">
                        ...
                        <span class="position-absolute top-0 left-100 translate-middle badge rounded-pill bg-light text-dark left-0">+99</span>
                    </a>
                </div>
            </div>
            ...
            <form class="col-md-9 m-auto" method="post" role="form">
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control mt-1" id="email" name="email" placeholder="ایمیل">
                    </div>
                </div>
                <div class="mb-3">
        ...
        <div class="row text-light mb-4">
            ...
            <div class="col-auto">
                ...
                <div class="input-group mb-2">
                    ...
                    <div class="input-group-text btn-success text-light">عضویت</div>
                </div>
            </div>
        </div>
    </div>
